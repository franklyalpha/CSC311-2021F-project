...
import torch
    ...
    """Concatenated student meta data with the sparse matrix. 
    """
...
def load_data(base_path="./data"):
    ...
    # # Concatenate the sparse matrix with the student meta data
    # updated_train_matrix = np.concatenate((train_matrix, student_meta), axis=1)
    # zero_train_matrix = updated_train_matrix.copy()
    # # Fill in the missing entries to 0.
    # zero_train_matrix[np.isnan(train_matrix)] = 0
    # # Change to Float Tensor for PyTorch.
    # zero_train_matrix = torch.FloatTensor(zero_train_matrix)
    # updated_train_matrix = torch.FloatTensor(updated_train_matrix)
