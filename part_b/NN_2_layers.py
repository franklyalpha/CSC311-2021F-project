...
class AutoEncoder(nn.Module):
    ...
    def forward(self, inputs):
        ...
        hidden2 = self.decode1.forward(hidden1_act)
        outer = self.h.forward(hidden2)
...
def train(model, lr, lamb, train_data, zero_train_data, valid_data, num_epoch):
    ...
    # with open("nn2_valid_acc.txt", "w") as fp:
    #     json.dump(valid_acc_record, fp)
    # with open("nn2_epoch.txt", "w") as fp:
    #     json.dump(epoch_record, fp)
    #####################################################################
    #                       END OF YOUR CODE                            #
    #####################################################################
